...
PIPELINE_ANYGRASP_MAX_POINTS=${AFFORDGRASP_ANYGRASP_MAX_POINTS:-80000}
...
PIPELINE_RUN_ROOT=$PIPELINE_PROJECT_DIR/runs
...
run_grasp() {
  ...
  local -a grasp_command=(
    ...
    --max-scene-points "$PIPELINE_ANYGRASP_MAX_POINTS"
  )
